...
public class KirklandServerImpl implements CampusServerInterface
            {	
...
@Override
    ...
    { BufferedWriter output = null;
	  DateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	  Date d1 = new Date();
	  String sStatus,sTimeSlot,sWestmountSentence = "11",sDorvalSentence = "11",sStudentId;
      Iterator itr;
	  synchronized(this){	   
	...
	private String bookRoomKirkland(String sStudentId,String roomNumber,String date,String timeslot) 
	    { String sBookingId;
...
@Override	    
	...
	private String getAvailableTimeSlotKirkland(String date)
...
@Override    
	...
	private String cancelBookingKirkland(String sBookingID)
	{ BufferedWriter output = null;
	  DateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	  Date d1 = new Date();
...
@Override
    ...
    if (newCampusName.equals("Kirkland"))
        sBookingStatus = bookRoomKirkland(studentId,newRoomNo,bookingDate,newTimeSlot);  
    ...
    if (bookingId.charAt(0)=='K'&&  sBookingStatus!=null &&sBookingStatus.contains("Room Booked."))
        sBookingCancelStatus = cancelBookingKirkland(studentId+bookingId);
   ...
   { sStatus="Booking Slot Transfer Un-Successful";
     ...
     if (sNewBookingId.charAt(0)=='K')
         sBookingCancelStatus = cancelBookingKirkland(studentId+sNewBookingId);
      else
      ...
      { sStatus="Slot Transfer Un-Successful";
      }
   return sStatus;   
 }	
 }